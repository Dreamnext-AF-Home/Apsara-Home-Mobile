          ...
          <View style={styles.categoriesGrid}>
            {categories.map((category, index) => (
              <Pressable
                ...
                style={[styles.categoryItem, { backgroundColor: themeColors.cardBg, borderColor: themeColors.cardBorder }]}
              ...
              >
                ...
                <Text style={[styles.categoryName, { color: themeColors.text }]} numberOfLines={2}>{category.name}</Text>
                {category.product_count && (
                  <Text style={[styles.categoryCount, { color: themeColors.textSecondary }]}>
